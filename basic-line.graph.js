...
d3.tsv("data/data.tsv", function(error, data) {
    ...
    /**
     * If adding a color gradient for the line see color-gradient.js
     */
    ...
    // Add each data value as a point if desired.  Better to place after line generation as putting it first cause the line to display on top of the dots
    svg.selectAll("dot")
        .data(data)
        .enter().append("circle")
        .attr("r", 3.5)
